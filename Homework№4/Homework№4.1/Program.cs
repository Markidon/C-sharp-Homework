...
namespace Homework_4
{
    class Program
    {
        ...
        {
            Console.WriteLine(GetFullName("Степаненко", "Марк", "Владимировчи"));
            Console.WriteLine(GetFullName("Путин", "Марк", "Владимировчи"));
            Console.WriteLine(GetFullName("Дементьев", "Марк", "Владимировчи"));
